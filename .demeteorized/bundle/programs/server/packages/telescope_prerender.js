...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/package-i18n.js                                                                       //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
TAPi18n.packages["telescope:prerender"] = {"translation_function_name":"__","helper_name":"_","namespace":"project"};
                                                                                                                      // 2
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/lib/prerender-setting.js                                                              //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
Settings.addField({                                                                                                   // 1
  fieldName: "prerenderIOToken",                                                                                      // 2
  propertyGroup: "prerender",                                                                                         // 3
  fieldSchema: {                                                                                                      // 4
    type: String,                                                                                                     // 5
    optional: true,                                                                                                   // 6
    "private": true,                                                                                                  // 7
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/lib/server/prerender.js                                                               //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
if (Settings.get('prerenderIOToken')) {                                                                               // 1
                                                                                                                      //
  var siteUrl = Settings.get('siteUrl') || Meteor.absoluteUrl();                                                      // 3
  var protocol = siteUrl.indexOf('https') !== -1 ? 'https' : 'http';                                                  // 4
                                                                                                                      //
  var prerender = Npm.require('prerender-node').set('protocol', protocol).set('host', siteUrl.replace('http://', '').replace('/', '')).set('prerenderToken', Settings.get('prerenderIOToken'));
                                                                                                                      //
  Meteor.startup(function () {                                                                                        // 11
    WebApp.rawConnectHandlers.use(prerender);                                                                         // 12
  });                                                                                                                 //
}                                                                                                                     //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/ar.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
    package_name = "telescope:prerender",                                                                             // 2
    namespace = "telescope:prerender";                                                                                // 3
                                                                                                                      // 4
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/bg.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/cs.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
if(_.isUndefined(TAPi18n.translations["cs"][namespace])) {                                                            // 12
  TAPi18n.translations["cs"][namespace] = {};                                                                         // 13
                                                                                                                      ...
                                                                                                                      // 15
_.extend(TAPi18n.translations["cs"][namespace], {});                                                                  // 16
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/da.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/de.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/el.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/en.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
translations = {};                                                                                                    // 9
translations[namespace] = {"prerenderIOToken":"Prerender.io Token"};                                                  // 10
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/es.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/et.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
if(_.isUndefined(TAPi18n.translations["et"][namespace])) {                                                            // 12
  TAPi18n.translations["et"][namespace] = {};                                                                         // 13
                                                                                                                      ...
                                                                                                                      // 15
_.extend(TAPi18n.translations["et"][namespace], {});                                                                  // 16
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/fr.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
if(_.isUndefined(TAPi18n.translations["fr"][namespace])) {                                                            // 12
  TAPi18n.translations["fr"][namespace] = {};                                                                         // 13
                                                                                                                      ...
                                                                                                                      // 15
_.extend(TAPi18n.translations["fr"][namespace], {});                                                                  // 16
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/hu.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/id.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
if(_.isUndefined(TAPi18n.translations["id"][namespace])) {                                                            // 12
  TAPi18n.translations["id"][namespace] = {};                                                                         // 13
                                                                                                                      ...
                                                                                                                      // 15
_.extend(TAPi18n.translations["id"][namespace], {});                                                                  // 16
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/it.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/ja.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/kk.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/ko.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/nl.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/pl.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/pt-BR.i18n.js                                        //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/ro.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/ru.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/sl.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
if(_.isUndefined(TAPi18n.translations["sl"][namespace])) {                                                            // 12
  TAPi18n.translations["sl"][namespace] = {};                                                                         // 13
                                                                                                                      ...
                                                                                                                      // 15
_.extend(TAPi18n.translations["sl"][namespace], {});                                                                  // 16
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/sv.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
if(_.isUndefined(TAPi18n.translations["sv"][namespace])) {                                                            // 12
  TAPi18n.translations["sv"][namespace] = {};                                                                         // 13
                                                                                                                      ...
                                                                                                                      // 15
_.extend(TAPi18n.translations["sv"][namespace], {});                                                                  // 16
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/th.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/tr.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/vi.i18n.js                                           //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                    //
// packages/telescope_prerender/packages/telescope_prerenderi18n/zh-CN.i18n.js                                        //
//                                                                                                                    //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                      //
var _ = Package.underscore._,                                                                                         // 1
...
Package['telescope:prerender'] = {};

})();

//# sourceMappingURL=telescope_prerender.js.map
